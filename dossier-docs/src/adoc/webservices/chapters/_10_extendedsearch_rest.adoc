...
[source]
----
http://<hostname>:<port>/<context>/rest/api-docs?url=/<context>/rest/swagger.json#/extendSearch
----
...
|[lime]*200*|Opération réussie. Structure de retour <<extendedearchjson_response>>
