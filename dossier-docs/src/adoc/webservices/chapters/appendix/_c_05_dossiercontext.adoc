...
** *authority*: champ associé à une _liste d'authorité_
...
|*reference*|Champ référence ?|si _true_, cela signifie que ce champ est rattaché à une liste (utilisateur, organisation, liste d'authorité)|_boolean_
