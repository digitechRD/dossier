...
Il suffit ensuite d'indiquer au sein de la structure *documentsData* via le paramètre *filesIndex* les index des pièces jointes qui devront être ajoutés pour le document.
