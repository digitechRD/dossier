...
[NOTE]
====
Aucun paramètre d'entrée n'est requis pour l'utilisation de ce service.
====
...
|[lime]*200*|Opération réussie. Structure de retour <<authoritylist_getcodejson_response>>
...
|===
|Code Http|Description
|[lime]*200*|Opération réussie. Structure de retour <<authoritylist_gettermsjson_response>>
