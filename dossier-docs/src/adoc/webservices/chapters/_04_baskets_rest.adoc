...
----
curl -X 'GET' \
  'http://<host>:<port>/<context>/rest/baskets?delegated=nfe' \
...
----
curl -X 'GET' \
  'http://<host>:<port>/<context>/rest/baskets/orgId/24?flowCode=PRO?delegated=nfe' \
  -H 'accept: application/json' \
  -H 'Authorization: Basic <credencials>'
----
...
----
curl -X 'GET' \
  'http://<host>:<port>/<context>/rest/baskets/flowCode/PRO?delegated=nfe' \
  -H 'accept: application/json' \
  -H 'Authorization: Basic <credencials>'
----
...
----
curl -X 'GET' \
  'http://<host>:<port>/<context>/rest/baskets/docCount/Derniers%20compte%20rendus?orgId=24&flowCode=PRO&delegated=nfe' \
  -H 'accept: application/json' \
  -H 'Authorization: Basic <credencials>'
----
...
----
curl -X 'GET' \
  'http://<host>:<port>/<context>/rest/baskets/docLink/Derniers%20compte%20rendus?orgId=24&flowCode=PRO&delegated=nfe' \
  -H 'accept: application/json' \
  -H 'Authorization: Basic <credencials>'
----
