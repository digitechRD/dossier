...
La classe `com.digitech.dossier.rest.ws.impl.HierarchyClient` de la librairie *com.digitech.airs:dossier-rest-client:{dossier-rest-client-version}* abstrait
