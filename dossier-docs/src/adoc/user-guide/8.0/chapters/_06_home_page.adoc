...
.Page d'accueil
image:06_home_page/image165.png[width=680,height=431]
...
nécessaire de cliquer sur l'action image:06_home_page/image166.png[width=16,height=16].
* L’*Accès rapide* affiche les 5 derniers documents vus sous forme de vignette (cf. Accès rapide page 47).
* La *Recherche globale* disponible depuis le bandeau supérieur est représentée par un champ de saisie accompagné d’une loupe image:06_home_page/image167.png[width=20,height=20].
...
* L’accès à la liste des documents image:06_home_page/image168.png[width=32,height=31] *Favoris* et image:06_home_page/image169.png[width=32,height=31] *Favoris avec suivi*. À noter qu’en cliquant sur
image:06_home_page/image168.png[width=32,height=31] *Favoris*, vous accéderez à tous les favoris, ceux avec suivi inclus.
...
.Accès rapide
image:06_home_page/image170.png[width=745,height=227]
...
image:06_home_page/image171.png[width=680,height=193]
...
image:06_home_page/image172.png[width=318,height=213]
...
.Création de document
image:06_home_page/image173.png[width=680,height=266]
...
.Déposer une pièce jointe
image:06_home_page/image177.png[width=515,height=234]
...
image:06_home_page/image178.png[width=478,height=362]
...
fichiers. Un clic sur l'action image:06_home_page/image179.png[height=36] permet alors de créer le document. À l'issu de la création du document, la *Vue Document* de ce dernier est affichée.

[NOTE]
====
Un clic sur l'action image:06_home_page/image180.png[width=56,height=36] permet de créer plusieurs documents à la suite. Il peut être intéressant
...
image:06_home_page/image183.png[width=680,height=337]
...
image:06_home_page/image184.png[width=623,height=168]
...
.Recherche globale
image:06_home_page/image185.png[width=680,height=154]

On retrouve les options de recherche suivante (qui peuvent être activées/désactivées image:06_home_page/image186.png[width=12,height=12] par simple clic) :
...
image:06_home_page/image187.png[width=680,height=220]
...
Il suffit de saisir les termes recherchés puis de cliquer sur la loupe image:06_home_page/image167.png[width=20,height=20] ou d’appuyer sur la touche Entrée du
...
image:06_home_page/image188.png[width=680,height=255]

Pour chaque résultat on retrouve les options suivantes :

* *Actions*
image:06_home_page/image189.png[width=25,height=25] : déploie les actions suivantes sur le document correspondant :
** Supprimer
image:06_home_page/image191.png[height=23]
** Envoyer un email
image:06_home_page/image192.png[width=29,height=21]
** Ajouter au favoris
image:06_home_page/image77.png[height=24]
* *Afficher la vue document*
image:06_home_page/image193.png[width=28,height=28]
* *Afficher le document*
image:06_home_page/image195.png[width=25,height=25] : permet d’afficher le document dans la visionneuse.
...
image:06_home_page/image197.png[width=680,height=101]

Il est possible de filtrer les résultats de la *recherche globale*. La zone de paramétrage du filtre peut être affichée/masquée en cliquant sur le bouton image:06_home_page/image198.png[width=43,height=36] situé en haut à droite. Le filtre se présente comme suit :

.Recherche globale filtre
image:06_home_page/image199.png[width=371,height=304]


La liste déroulante dans la partie supérieure permet de déterminer l’élément à filtrer :

.Recherche globale filtre 2
image:06_home_page/image200.png[width=238,height=205]
...
.Appliquer le filtre
image:06_home_page/image201.png[width=470,height=203]

Le filtre peut être désactivé en cliquant sur le bouton *Réinitialiser le filtre* situé juste à côté :

.Réinitialiser le filtre
image:06_home_page/image202.png[width=257,height=192]
