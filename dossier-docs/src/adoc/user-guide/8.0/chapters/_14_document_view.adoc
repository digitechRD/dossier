...
.Vue unitaire
image:14_document_view/image296.png[width=680,height=306]
...
.Actions
image:14_document_view/image297.png[width=680,height=104]
...
* image:14_document_view/image298.png[width=60,height=38]
permet de passer en mode *EDITION*.
Le document est alors automatiquement verrouillé.
* image:14_document_view/image299.png[width=60,height=38]
...
* image:14_document_view/image191.png[width=19,height=23]
...
* image:14_document_view/image300.png[width=23,height=20]permet de copier une url d’accès public à ce document dans le presse-papier.
...
* image:14_document_view/image192.png[width=29,height=21]permet d'envoyer un e-mail (les pièces jointes du document peuvent être insérées dans le mail). :

image:14_document_view/image301.png[width=490,height=385]
...
image:14_document_view/image302.png[height=22] pour valider l’envoi de votre mail.
Cliquez sur
image:14_document_view/image303.png[height=22] pour refermer cet écran sans envoyer le mail

* image:14_document_view/image304.png[height=19]
permet d'ajouter le document courant aux *Favoris*.
* image:14_document_view/image92.png[height=19] permet d'afficher les signets.
* image:14_document_view/image282.png[height=19] permet d’effectuer une demande de signature (cf.
Effectuer une demande de signature page 113).
* image:14_document_view/image305.png[height=19] permet de copier/dupliquer/lier le document (un menu contextuel s'affiche afin de proposer l'action à réaliser).
Pour plus d’information sur cette fonctionnalité, consultez le chapitre Presse-papier page 70.

* image:14_document_view/image306.png[height=24] (affichée seulement si le *Plan de classement* est visible) permet de punaiser le document.
...
L'action
image:14_document_view/image307.png[height=24] permet quant à elle de dépunaiser le document.

==== Actions de Workflow AIRS

* L'action secondaire
image:14_document_view/image308.png[height=24]
...
* image:14_document_view/image309.png[height=23]
...
* image:14_document_view/image310.png[height=18]
...
* image:14_document_view/image311.png[height=33]
...
.Onglet contenu
image:14_document_view/image312.png[width=680,height=297]
...
.Onglet pièce jointe
image:14_document_view/image313.png[width=680,height=337]
...
** image:14_document_view/image218.png[width=22,height=14] :
permet de visualiser la pièce jointe via la fenêtre de visualisation.
** image:14_document_view/image314.png[width=23,height=23] :
permet de télécharger la pièce jointe.
** image:14_document_view/image141.png[width=37,height=37] :
...
** image:14_document_view/image143.png[width=28,height=28] :
permet de modifier les informations liées à la pièce jointe.
** image:14_document_view/image160.png[width=24,height=23] :
...
image:14_document_view/image94.png[width=17,height=9]; la fenêtre de visualisation de pièce jointe est alors affichée.

Pour supprimer une pièce jointe, il faut au préalable cocher le(s) pièce(s) jointe(s) puis cliquer sur l’action
image:14_document_view/image191.png[width=19,height=23] :

.Supprimer une pièce jointe
image:14_document_view/image316.png[width=680,height=164]
...
[arabic]
. Via le bouton
image:14_document_view/image49.png[width=21,height=20] :
...
image:14_document_view/image317.png[width=480,height=224]
...
[arabic,start=3]
. Via la numérisation
image:14_document_view/image160.png[height=23]
...
.Pièce jointe
image:14_document_view/image318.png[width=495,height=464]
...
.Onglet lien
image:14_document_view/image319.png[width=680,height=236]
...
image:14_document_view/image320.png[width=503,height=554]
...
.Onglet historique
image:14_document_view/image321.png[width=680,height=441]
...
.Onglet Signature
image:14_document_view/image322.png[width=680,height=289]
...
.Onglet commentaire
image:14_document_view/image323.png[width=680,height=257]
...
image:14_document_view/image324.png[width=18,height=22].
Un message de confirmation s'affiche avant d'appliquer la suppression.
...
image:14_document_view/image325.png[width=21,height=21], la fenêtre *Ajout/Modification d’un Commentaire* s’ouvre alors :

.Ajout de commentaire
image:14_document_view/image326.png[width=487,height=507]
...
.Arborescence
image:14_document_view/image327.png[width=680,height=255]
...
image:14_document_view/image328.png[width=20,height=20].

L'action
image:14_document_view/image329.png[width=21,height=15]
permet de réinitialiser l'arborescence afin d’afficher à nouveau son état initial.

Les boutons
image:14_document_view/image330.png[width=18,height=13]
et
image:14_document_view/image331.png[width=18,height=13]
ont été ajoutés afin de respectivement déployer ou de réduire en un clic l’intégralité de l’arborescence :

.Arbre déplié
image:14_document_view/image332.png[width=456,height=185]

.Arbre replié
image:14_document_view/image333.png[width=455,height=185]
...
image:14_document_view/image334.png[width=455,height=217]
...
* Nœud dossier
image:14_document_view/image335.png[width=16,height=16] :
...
* Nœud document
image:14_document_view/image336.png[width=16,height=16] :
...
image:14_document_view/image339.png[width=25,height=25]
...
image:14_document_view/image340.png[width=432,height=185]
...
image:14_document_view/image341.png[width=322,height=183]
...
image:14_document_view/image342.png[width=11,height=11] ).
