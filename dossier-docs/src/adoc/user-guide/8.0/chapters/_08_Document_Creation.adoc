...
fichiers. Un clic sur l'action image:08_Document_Creation/image179.png[pdfwidth=24,role="size-24"] permet alors de créer le document. À l'issue de la création du document, la *Vue Document* de ce dernier est affichée.

[NOTE]
====
Un clic sur l'action image:08_Document_Creation/image180.png[pdfwidth=24,role="size-24"] permet de créer plusieurs documents à la suite. Il peut être intéressant
