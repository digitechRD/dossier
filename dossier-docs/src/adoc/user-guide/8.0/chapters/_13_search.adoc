...
Depuis la page d'*Accueil* de l'application, la fonctionnalité de *Recherche* est accessible depuis image:icons/header_other_actions.svg[30,30] via le sous-menu *Recherche*, *Recherche avancée* et *Recherche Plein texte*.

Il existe quatre types de recherche :

* La *Recherche globale* image:icons/header_search.svg[30,30] (qui inclue la recherche *Plein Texte* image:icons/Ico_PleinTexte.png[30,30] si activée).
...
La *Recherche Simple*, accessible depuis la barre de navigation en suivant le chemin image:icons/header_other_actions.svg[30,30] > *Recherche* permet de réaliser des recherches AIRS en spécifiant des valeurs pour un ensemble de critères.
...
On accède à cette page via la barre de navigation en cliquant sur image:icons/header_other_actions.svg[30,30] > *Recherche dans les documents supprimés*.
