...
L’icône
image:16_signature/image348.png[height=33]
permet d’afficher les informations générales concernant ce certificat.

Une fois le document à signer et le certificat sélectionnés, vous pouvez démarrer l’étape de signature en cliquant sur image:16_signature/image349.png[height=36].
Après avoir cliqué sur image:16_signature/image349.png[], si le certificat est valide, vous devrez saisir le code confidentiel associé au certificat :
...
image:16_signature/image352.png[width=60,height=38] :
...
image:16_signature/image349.png[height=36]/image:16_signature/image352.png[width=57,height=36]
...
image:16_signature/image355.png[height=35].
...
Tous documents contenant des documents signés seront accompagnés du symbole image:16_signature/image357.png[height=20] en *Vue résultats* :
...
image:16_signature/image359.png[height=24].
...
image:16_signature/image149.png[width=19,height=19]
...
image:16_signature/image282.png[height=19](ce bouton sera disponible uniquement si le module de signature est activé).
...
Après avoir cliqué sur image:16_signature/image282.png[], l’écran de *Sélection des documents à signer* apparaît :
...
image:16_signature/image282.png[height=19] :
