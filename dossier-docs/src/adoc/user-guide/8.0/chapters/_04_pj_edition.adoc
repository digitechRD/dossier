...
Lorsque vous éditez un document via le bouton image:04_pj_edition/image141.png[width=29,height=29]
ou image:04_pj_edition/image143.png[width=23,height=23] une fenêtre de téléchargement liée au navigateur apparait pour le
fichier correspondant :

.Ouverture d'une pièce jointe
image:04_pj_edition/image145.png[width=487,height=449]
...
image:04_pj_edition/image146.png[width=523,height=456]
...
image:04_pj_edition/image147.png[width=401,height=192]
...
image:04_pj_edition/image148.png[width=404,height=113]

Hors version courante, vous pouvez supprimer la pièce jointe sélectionnée en cliquant sur image:04_pj_edition/image149.png[width=19,height=19].
...
image:04_pj_edition/image150.png[height=17] ou image:04_pj_edition/image151.png[height=17] :
...
image:04_pj_edition/image152.png[width=565,height=107]
