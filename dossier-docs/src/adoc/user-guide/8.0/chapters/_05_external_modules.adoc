...
image:05_external_modules/image153.png[width=347,height=262]
...
image:05_external_modules/image154.png[width=421,height=305]
...
.Choix de l'éditeur
image:05_external_modules/image155.png[width=636,height=160]
...
image:05_external_modules/image156.png[width=572,height=144]
...
image:05_external_modules/image157.png[width=636,height=160]
...
image:05_external_modules/image158.png[width=276,height=162]
...
image:05_external_modules/image159.png[width=680,height=256]

==== Module de scan

Lors de la première utilisation du module de scan, en cliquant sur image:05_external_modules/image160.png[height=23]
pour scanner un fichier, le téléchargement du fichier du module sera automatiquement lancé :

.Télécharger le module de scan
image:05_external_modules/image161.png[width=368,height=278]
...
image:05_external_modules/image162.png[width=311,height=127]
...
image:05_external_modules/image163.png[width=238,height=130]

.Module impression
image:05_external_modules/image164.png[width=366,height=93]
