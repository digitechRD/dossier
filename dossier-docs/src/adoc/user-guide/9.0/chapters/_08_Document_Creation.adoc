...
Document* est disponible depuis le bouton image:icons/icon_add.png[pdfwidth=24,role="size-24"] ou via le menu *Options* > *Création* depuis l’écran d’accueil.
...
pourrez la supprimer grâce au bouton de suppression image:icons/icon_delete_pj.png[] .
...
image:08_Document_Creation/planClassement.png[]
