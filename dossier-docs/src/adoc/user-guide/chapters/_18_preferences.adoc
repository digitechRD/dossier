...
image:media/image299.png[height=38] afin d'appliquer et de sauvegarder les modifications effectuées dans les préférences.
...
image:media/image49.png[height=20] ; la fenêtre modale *Ajout/Modification d'une délégation* s'ouvre :
...
image:media/image49.png[width=18,height=17] situé dans le bandeau supérieur.
...
L’icône image:media/image380.png[width=19,height=14] permet de supprimer le contact correspondant.
...
Si le nouveau mot de passe respecte les règles de nommage, un clic sur l'action image:media/image299.png[height=38] permet de le rendre effectif.
