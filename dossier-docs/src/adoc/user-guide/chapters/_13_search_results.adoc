...
image:media/image273.png[height=15] (selon les droits de l'utilisateur).
...
Après un clic sur l’action image:media/image191.png[] les options suivantes pourront vous être proposées :
...
Afin d'ordonner la liste des résultats de recherche, des outils de tri sont disponibles en haut de certaines colonnes (des menus déroulants, des flèches de tri (image:media/image289.png[flèches tri,width=19,height=20]) ou des champs vides).
Il est possible de faire des tris multicolonnes.
...
image:media/image290.png[height=16].
...
plusieurs filtres pouvant être utilisés simultanément,vous pouvez annuler l’effet de tous les filtres utilisés en cliquant sur l’icône image:media/image291.png[height=20].
...
image:media/image292.png[width=20,height=22] qui apparait lorsque vous passez le curseur de la souris dans l’encadré supérieur d’une colonne (comme dans la colonne *Actions* ci-dessous) :

.Modifier l'affichage des colonnes
image:media/image293.png[width=260,height=171]

Cliquez sur l’icône
image:media/image292.png[width=20,height=22] afin de personnaliser l’affichage des colonnes ; de nouvelles options apparaissent :
