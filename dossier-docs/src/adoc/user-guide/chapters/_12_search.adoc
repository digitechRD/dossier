...
image:media/image37.png[width=26,height=26], permet de sélectionner une date.
...
image:media/image39.png[] permet de sélectionner une organisation.
* Picker d'autorité : accessible en cliquant sur l'icône
image:media/image41.png[] permet de sélectionner un élément d'une liste d'autorité.
* Picker d'utilisateur : accessible en cliquant sur l'icône
image:media/image43.png[width=24,height=24], permet de sélectionner un utilisateur.
...
image:media/image248.png[width=20,height=24] pour ajouter une parenthèse ouvrante.
...
L'action
image:media/image251.png[width=28,height=27] (*ET*) permet d'ajouter l'opérateur d'intersection interlocutions (elle permet ainsi de cumuler les effets de différentes locutions).
L'action
image:media/image252.png[width=22,height=27] (*SAUF*) permet d'ajouter l'opérateur de négation interlocutions (permet par exemple d’exclure certaines valeurs de la recherche).
L'action
image:media/image253.png[width=24,height=24] (*OU*) permet d'ajouter l'opérateur d'union interlocutions (permet par exemple de différencier deux groupes de locutions basés sur des critères différents, ainsi l’élément recherché devra correspondre aux critères de l’un des deux groupes et non aux critères cumulés des deux groupes).
...
image:media/image257.png[width=34,height=34]) ou de restaurer (bouton
image:media/image254.png[width=34,height=34]) uniquement votre sélection :
