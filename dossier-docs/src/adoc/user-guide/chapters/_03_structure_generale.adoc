...
[NOTE]
====
Il est possible de minimiser l'en-tête de page en cliquant sur l'icône image:media/image16.jpg[width=12,height=12].
Une fois l'en-tête de page minimisé, il est alors possible de le maximiser en cliquant sur l'icône image:media/image17.jpg[width=12,height=12].
====
...
.Barre d'actions
image:media/image19.jpeg[width=599,height=97]
...
image:media/image25.jpeg[width=755,height=207]
...
Le picker de date, symbolisé par l’icône image:media/image37.jpeg[width=37,height=37],
...
|===
|Boutons |Actions correspondantes
|image:media/image61.gif[width=24,height=24]/image:media/image62.gif[width=24,height=24]
|Naviguer de page en page au sein d’un document.

|image:media/image63.gif[width=24,height=24]/image:media/image64.gif[width=24,height=24]
...
|image:media/image65.gif[width=24,height=24]/
image:media/image66.gif[width=24,height=24]
...
|image:media/image74.gif[width=24,height=24]/
image:media/image75.gif[width=24,height=24]
|Maximiser/minimiser la taille occupée par la *visionneuse*.

|image:media/image76.gif[width=24,height=24]
|Imprimer le fichier affiché.

|image:media/image77.gif[width=24,height=24]
|*Marquer cette page…* : permet d’ajouter un signet. Cette
fonctionnalité est décrite plus en détails ci-après.

|image:media/image78.gif[width=24,height=24]
...
|image:media/image79.gif[width=24,height=24]
...
image:media/image79.gif[width=24,height=24] affiche une fenêtre modale permettant de sélectionner les pages à copier
dans le *presse*-*papier*. Cette fonctionnalité est décrite plus en
détails ci-après.

|image:media/image80.gif[width=24,height=24]
|*Insérer des pages…* issues du *presse*-*papier* au sein d'une pièce
jointe de même type (selon les droits de l'utilisateur). Cette
fonctionnalité est décrite plus en détails ci-après.

|image:media/image81.gif[width=30,height=49]
...
|image:media/image83.gif[width=30,height=49]
...
|image:media/image85.gif[width=30,height=49] a|
...
image:media/image77.gif[width=24,height=24]
/ *Supprimer des pages…* image:media/image78.gif[width=24,height=24]
/ *Copier des pages…* image:media/image79.gif[width=24,height=24]
/ *Insérer des pages…* image:media/image80.gif[width=24,height=24].

* *Marquer cette page…* : (correspond à l’icône
image:media/image77.gif[height=24] de la *visionneuse*) cette fonctionnalité vous permet de déposer un
...
Pour accéder aux signets que vous avez créés (à l’aide de l’icône image:media/image77.gif[height=23]
...
* *Supprimer des pages…* : (correspond à l’icône image:media/image78.gif[height=24] de la *visionneuse*) un clic sur l'action de suppression de pages
...
* *Copier des pages…* : (correspond à l’icône image:media/image79.gif[height=24] de la *visionneuse*) cette fonctionnalité permet de copier ou une
...
* *Insérer des pages…* : (correspond à l’icône image:media/image80.gif[height=24]) permet d’insérer les pages précédemment copiées (via la fonction *Copier des pages* décrites ci-dessus) dans le document présent dans la *visionneuse*. En cliquant sur *Insérer des images*, l’écran de
...
Depuis la *visionneuse* intégrée, il est possible de cliquer sur l’icône image:media/image102.jpeg[width=26,height=26] pour ajouter une ou plusieurs
...
|===
|Boutons |Actions correspondantes
|image:media/image103.jpeg[width=31,height=31] /
image:media/image104.jpeg[width=31,height=32] |Zoomer / Dézoomer.

|image:media/image105.png[height=31] |Modifier l’affichage du document
(pleine largeur, pleine hauteur ou pleine page).

|image:media/image108.jpeg[width=31,height=31] / image:media/image109.jpeg[width=31,height=31] |
...
|image:media/image112.jpeg[annotation,width=31,height=31]
...
image:media/image112.jpeg[annotation,width=31,height=31] et faites un cliquer-glisser sur la pièce jointe. Une fenêtre s’ouvre.
...
image:media/image116.jpeg[width=259,height=94]
...
Selon le type d'annotation l'utilisateur doit survoler l'icône image:media/image118.jpg[width=32,height=32] afin d'afficher le détail de la note.
...
.Format msg
image:media/image139.jpeg[width=592,height=221]
