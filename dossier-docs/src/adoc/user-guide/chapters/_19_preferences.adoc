...
image:icons/icon_save.png[pdfwidth=24,role="size-24"] afin d'appliquer et de sauvegarder les modifications effectuées dans les préférences.
...
image:icons/icon_add_pj.png[pdfwidth=24,role="size-24"] ; la fenêtre modale *Ajout/Modification d'une délégation* s'ouvre :
...
image:icons/icon_add_pj.png[pdfwidth=24,role="size-24"] situé dans le bandeau supérieur.
...
L’icône image:icons/icon_delete_pj.png[pdfwidth=24,role="size-24"] permet de supprimer le contact correspondant.
