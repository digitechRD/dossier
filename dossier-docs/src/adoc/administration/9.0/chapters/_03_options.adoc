...
|*contact.phone.numbers.available.countries*|Codes (*ISO*) des pays pouvant être utilisés pour l'ajout de numéros de téléphone|List|[green]#Locale.getDefault
().getCountry()#. +
*+++*+++.+++*+++* permet d'indiquer tous les pays _"disponibles"_.
