...
|*dossier.search.result.card.mode.enabled*|[Résultat] Autoriser le mode d'affichage *cartes*|Boolean|true
...
|*misc.hierarchical.tree.enable.keyboard.navigation*|Autoriser la navigation dans l'arborescence à l'aide des flèches ↑ et ↓|Boolean|true
