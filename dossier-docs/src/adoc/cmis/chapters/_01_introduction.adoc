...
[IMPORTANT]
====
{dossier} founit une implémentation [underline]#restreinte# de la norme {cmis}, dans le sens où l'intégralité de la norme n'est pas implémentée.
...
* de manière un peu plus détaillé le protocole <<cmis_browser>>
