...
|*_attachment*|*com.digitech.dossier.common.model.backend.airs.IAttachment*|Attachment (document {airs})
|*_file*|*java.io.File*|Document/fichier uploadé
|*_mode*|AttachmentUploadEventMode|Mode (ajout/suppression). Valeurs possibles :

* *ADD* : Ajout (upload) d'une pièce jointe
* *REMOVE* : Suppression d'une pièce jointe (de la vue création)
3+|[.header]
Entrées/sorties
