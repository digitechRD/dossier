...
|*_context*|*String*|Contexte d'appel depuis lequel la règle est évaluée. +
Présent uniquement lors d'une évaluation au niveau document (absent dans les autres cas). +
Valeurs possibles :

* *ViewUnit* : fiche document (vue unitaire)
* *SearchTab* : résultats de recherche en mode *Tableau*
* *SearchCard* : résultats de recherche en mode *Vignettes/Cartes*
* *SearchKanban* : résultats de recherche en mode *Kanban*
...
[source, groovy]
.Exemple : n'autoriser l'action que dans la fiche document (et la masquer dans les résultats de recherche)
----
_result.setValid("ViewUnit" == _context)
----