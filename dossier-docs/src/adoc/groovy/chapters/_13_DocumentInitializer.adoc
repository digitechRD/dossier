...
|*_context*|*String*|Contexte d'appel depuis lequel l'action personnalisée est déclenchée. +
Présent uniquement lors de l'exécution d'une action personnalisée (absent pour les autres déclencheurs : sauvegarde, export, ...). +
Valeurs possibles :
