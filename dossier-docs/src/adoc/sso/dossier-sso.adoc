...
* *keyTabLocation*: [[underline]#*obligatoire*#] nom du `keytab` (localisé dans le répertoire *xml* de {dossier})
* *servicePrincipal*: [[underline]#*obligatoire*#] service principal utilisé lors de la génération du `keytab`
