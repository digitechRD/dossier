...
logger.debug("Script field initialization: validatorRequired_courrierIn.groovy --- Start");
...
//  
//  Object validator = theDocument.getField(CourrierScriptUtils.getConstant("FIELD_CODE_U_VALIDEUR")).getValue();
//  if (validator != null && CourrierScriptUtils.hasState(usrContext, theDocument, states)){
...
logger.debug("Script field initialization: validatorRequired_courrierIn.groovy --- End");
