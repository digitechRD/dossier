...
logger.debug("Script field dependency: generateChronoNumber_dependency_courrierIn.groovy --- Start");

String numChrono = CourrierScriptUtils.generateNumChronoActis(updatedField.getValue(), usrContext, true);
if (numChrono != null){
...
logger.debug("Script field dependency: generateChronoNumber_dependency_courrierIn.groovy --- End");