...
/**
 addFileToSafeBox_attach.groovy is a sample to show you how to add attachment into your own safebox
 **/
 ...
 * attachment     : the current IAttachment
 *
 */
...
String SUMMARY_MSG_OK = "safebox_add_attachment_sum_ok"
String DETAIL_MSG_OK = "safebox_add_attachmentc_detail_ok"
String SUMMARY_MSG_KO = "safebox_add_attachment_sum_ko"
String DETAIL_MSG_KO = "safebox_add_attachment_detail_ko"

// define interface name & owner id 
String SAFEBOX_INTERFACE_NAME = "SAFEBOX_INTERFACE"
...
try {
  ...
  dossierConnector.put(userContext, attachment)
  ...
  // log in log file
  scriptLogger.error("Error during inserting attachment in safeBox", ex)
}
