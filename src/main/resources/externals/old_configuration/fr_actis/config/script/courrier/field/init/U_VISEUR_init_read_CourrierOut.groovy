...
logger.debug("Script field initialization: U_VISEUR_init_read_CourrierOut.groovy --- Start");
...
logger.debug("Script field initialization: U_VISEUR_init_read_CourrierOut.groovy --- End");
