...
logger.debug("Script field initialization: D_ECHEANCE_init_read_CourrierOut.groovy --- Start");
...
logger.debug("Script field initialization: D_ECHEANCE_init_read_CourrierOut.groovy --- End");
