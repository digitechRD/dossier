...
Integer STATUT_FIELD_VALUE = 1702;

String MSG_SUCCESS_SUM = "msg_success_valid_sumary";
String MSG_SUCCESS_DETAIL = "msg_success_valid_detail";

String MSG_ERROR_SERVER_SUM = "msg_error_serv_valid_sumary";
String MSG_ERROR_SERVER_DETAIL = "msg_error_serv_valid_detail";

String MSG_ERROR_DOC_SUM = "msg_error_doc_valid_sumary";
String MSG_ERROR_DOC_DETAIL = "msg_error_doc_valid_detail";

String MSG_ERROR_IDENT_SUM = "msg_error_ident_valid_sumary";
String MSG_ERROR_IDENT_DETAIL = "msg_error_ident_valid_detail";
...
try
{
  ...
  if( document.getField( USR_FIELD_CODE ).getValue() != null )
  {
      ...
      String commentEvent = "Document valid\u00e9 par l'utilisateur " +  user;
