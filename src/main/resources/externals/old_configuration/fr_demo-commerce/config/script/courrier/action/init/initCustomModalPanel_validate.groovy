...
log.debug("Script triggered on init custom Modal Panel: initCustomModalPanel_validate.groovy --- Start");
...
customActionModel.setModalPanelTitle(BundleUtils.getTranslation("modalPanelValidate_title"));

log.debug("Script triggered on init custom Modal Panel: initCustomModalPanel_validate.groovy --- End");