<jsp:root version="2.0" xmlns:f="http://java.sun.com/jsf/core"
	...
	<h:panelGroup layout="block">
		<rich:panel rendered="#{CustomActionModel.modalPanelModel.DATA_ERROR_MSG==null and CustomActionModel.modalPanelModel.DATA_WARN_MSG==null}" style="height: 315px;">
			<h:outputLabel value="Informations" for="informations" />
			<h:selectOneMenu id="informations" value="#{CustomActionModel.modalPanelModel.information}" rendered="#{not empty CustomActionModel.modalPanelModel.informations}">
				<f:selectItems value="#{CustomActionModel.modalPanelModel.informations}"/>
			</h:selectOneMenu>
		</rich:panel>
		<center>
