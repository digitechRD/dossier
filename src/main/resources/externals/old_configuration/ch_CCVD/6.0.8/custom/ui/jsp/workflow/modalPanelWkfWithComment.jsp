<jsp:root version="2.0" xmlns:f="http://java.sun.com/jsf/core"
	...
	<h:panelGroup layout="block">
		<rich:panel rendered="#{CustomActionModel.modalPanelModel.DATA_ERROR_MSG==null and CustomActionModel.modalPanelModel.DATA_WARN_MSG==null}" style="border-width:0px;">
			...
			<h:outputText layout="block" style="font-size:11px; padding-left:190px;" value="Document(s) pour validation au service Finance" rendered="#{CustomActionModel.modalPanelModel.DATA_CONTROLE_FINANCE}"/>
			<h:selectBooleanCheckbox value="#{CustomActionModel.modalPanelModel.DATA_CONTROLE_FINANCE_VALUE}" style="float: none;" rendered="#{CustomActionModel.modalPanelModel.DATA_CONTROLE_FINANCE}"/>
			<br/>
