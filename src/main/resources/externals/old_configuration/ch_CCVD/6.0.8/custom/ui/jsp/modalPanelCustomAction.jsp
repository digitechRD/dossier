<jsp:root version="2.0" xmlns:f="http://java.sun.com/jsf/core"
	...
	<h:panelGroup layout="block">
		<rich:panel rendered="#{CustomActionModel.modalPanelModel.DATA_ERROR_MSG==null and CustomActionModel.modalPanelModel.DATA_WARN_MSG==null}" style="height: 310px;">
			<h:outputLabel value="Date : " for="date" />
			<rich:calendar id="date" datePattern="dd/MM/yy" enableManualInput="true" timeZone="#{ApplicationModel.timeZone}" locale="#{ApplicationModel.locale}" buttonClass="picker"
				inputStyle="vertical-align:top;"
				value="#{CustomActionModel.modalPanelModel.date}"
				showApplyButton="false" />

			<h:outputLabel value="Commentaire : " for="commentaire" />
			<h:inputTextarea maxlenght="255" cols="40" rows="3" value="#{CustomActionModel.modalPanelModel.comment}"/>
		</rich:panel>
		<center>
