...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW TO VALID SIMPLE VIEW INIT - START");
...
try {
    ...
    scriptLogger.error("[CUSTOM ACTION] - WorkflowToValidSimpleView - ERREUR : ",e);
    return;
}
...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW TO VALID SIMPLE VIEW INIT - END");