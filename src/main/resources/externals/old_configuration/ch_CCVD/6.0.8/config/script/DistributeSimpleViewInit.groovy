...
scriptLogger.debug("[CUSTOM ACTION] - DISTRIBUTE SIMPLE VIEW INIT - START");
...
try {
    ...
    scriptLogger.error("[CUSTOM ACTION] - DistributeSimpleViewInit - ERREUR : ",e);
    return;
}
...
try{
    ...
    scriptLogger.debug("[CUSTOM ACTION] - DistributeSimpleViewInit : Organisation Courante : "+userContext.getCurrentOrgId());
...
scriptLogger.debug("[CUSTOM ACTION] - DISTRIBUTE SIMPLE VIEW INIT - END");