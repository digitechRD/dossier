...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW TO CREATE NSS SIMPLE VIEW INIT - START");
...
try {
    ...
    scriptLogger.error("[CUSTOM ACTION] - WorkflowToCreateNSSSimpleView - ERREUR : ",e);
    return;
}
...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW TO CREATE NSS SIMPLE VIEW INIT - END");