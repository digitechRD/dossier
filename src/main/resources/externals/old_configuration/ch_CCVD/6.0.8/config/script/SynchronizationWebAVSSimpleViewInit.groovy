...
scriptLogger.debug("[CUSTOM ACTION] - SYNCHRONIZATION WEB@AVS SIMPLE VIEW INIT - START");
...
try {
    ...
    scriptLogger.error("[CUSTOM ACTION] - SynchronizationWebAVSSimpleViewInit - ERREUR : ",e);
    return;
}
...
scriptLogger.debug("[CUSTOM ACTION] - SYNCHRONIZATION WEB@AVS SIMPLE VIEW INIT - END");
