...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW EMAIL INDEXE SIMPLE VIEW INIT - START");
...
try {
    ...
    scriptLogger.error("[CUSTOM ACTION] - WorkflowEmailIndexeSimpleViewInit - ERREUR : ",e);
    return;
}
...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW EMAIL INDEXE SIMPLE VIEW INIT - END");