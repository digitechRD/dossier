...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW MUTATION IN PROGRESS SIMPLE VIEW INIT - START");
...
try {
    ...
    scriptLogger.error("[CUSTOM ACTION] - WorkflowMutationInProgressSimpleView - ERREUR : ",e);
    return;
}
...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW MUTATION IN PROGRESS SIMPLE VIEW INIT - END");