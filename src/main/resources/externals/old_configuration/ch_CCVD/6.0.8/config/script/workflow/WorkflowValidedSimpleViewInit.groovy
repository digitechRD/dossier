...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW VALIDED SIMPLE VIEW INIT - START");
...
try {
    ...
    scriptLogger.error("[CUSTOM ACTION] - WorkflowValidedSimpleView - ERREUR : ",e);
    return;
}
...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW VALIDED SIMPLE VIEW INIT - END");