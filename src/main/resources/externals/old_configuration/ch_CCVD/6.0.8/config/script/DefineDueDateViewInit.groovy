...
scriptLogger.debug("[CUSTOM ACTION] - DEFINE DUE DATE VIEW INIT - START");
...
try {
    ...
    scriptLogger.error("[CUSTOM ACTION] - DefineDueDateViewInit - ERREUR : ",e);
    return;
}
...
scriptLogger.debug("[CUSTOM ACTION] - DEFINE DUE DATE VIEW INIT - END");
