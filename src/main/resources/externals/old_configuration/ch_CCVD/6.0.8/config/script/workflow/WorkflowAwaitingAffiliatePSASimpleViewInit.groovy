...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW AWAITING AFFILIATE PSA SIMPLE VIEW INIT - START");
...
try {
    ...
    scriptLogger.error("[CUSTOM ACTION] - WorkflowAwaitingAffiliatePSASimpleViewInit - ERREUR : ",e);
    return;
}
...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW AWAITING AFFILIATE PSA SIMPLE VIEW INIT - END");