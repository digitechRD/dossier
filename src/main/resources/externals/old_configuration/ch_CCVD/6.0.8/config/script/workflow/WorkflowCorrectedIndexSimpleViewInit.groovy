...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW CORRECTED INDEX SIMPLE VIEW INIT - START");
...
try {
    ...
    scriptLogger.error("[CUSTOM ACTION] - WorkflowCorrectedIndexSimpleView - ERREUR : ",e);
    return;
}
...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW CORRECTED INDEX SIMPLE VIEW INIT - END");