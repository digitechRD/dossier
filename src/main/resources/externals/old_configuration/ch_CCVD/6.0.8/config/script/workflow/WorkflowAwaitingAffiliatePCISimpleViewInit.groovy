...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW AWAITING AFFILIATE PCI SIMPLE VIEW INIT - START");
...
try {
    ...
    scriptLogger.error("[CUSTOM ACTION] - WorkflowAwaitingAffiliateEMPSimpleViewInit - ERREUR : ",e);
    return;
}
...
try{
    ...
    Methods.addStateMessage(data, "DATA_ERROR_MSG", "Erreur lors de l'initialisation du traitement. Veuillez contacter votre administrateur", false);
    scriptLogger.error("[CUSTOM ACTION] - WorkflowAwaitingAffiliatePCISimpleViewInit - ERREUR : ", e);
    return;
}

scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW AWAITING AFFILIATE PCI SIMPLE VIEW INIT - END");