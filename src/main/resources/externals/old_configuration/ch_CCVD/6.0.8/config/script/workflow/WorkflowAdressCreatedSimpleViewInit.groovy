...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW ADRESS CREATED SIMPLE VIEW INIT - START");
...
try {
    ...
    scriptLogger.error("[CUSTOM ACTION] - WorkflowAdressCreatedSimpleView - ERREUR : ",e);
    return;
}
...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW ADRESS CREATED SIMPLE VIEW INIT - END");