...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW AWAITING AFFILIATE EMP SIMPLE VIEW INIT - START");
...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW AWAITING AFFILIATE EMP SIMPLE VIEW INIT - END");