...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW REQUEST MOORED SIMPLE VIEW INIT - START");
...
try {
    ...
    scriptLogger.error("[CUSTOM ACTION] - WorkflowRequestMooredSimpleView - ERREUR : ",e);
    return;
}
...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW REQUEST MOORED SIMPLE VIEW INIT - END");