...
scriptLogger.debug("[CUSTOM ACTION] - REALLOCATION SERVICE SIMPLE VIEW INIT - START");
...
try {
    ...
    scriptLogger.error("[CUSTOM ACTION] - ReallocationServiceSimpleViewInit - ERREUR : ",e);
    return;
}
...
try{
    ...
    scriptLogger.debug("[CUSTOM ACTION] - ReallocationServiceSimpleViewInit - DEBUG - ORGANISATION COURANTE : "+organizationId.toString());
...
scriptLogger.debug("[CUSTOM ACTION] - REALLOCATION SERVICE SIMPLE VIEW INIT - END");
