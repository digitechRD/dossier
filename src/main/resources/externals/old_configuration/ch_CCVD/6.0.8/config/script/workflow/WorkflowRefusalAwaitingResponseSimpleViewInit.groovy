...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW REFUSAL AWAITING RESPONSE SIMPLE VIEW INIT - START");
...
try {
    ...
    scriptLogger.error("[CUSTOM ACTION] - WorkflowRefusalAwaitingResponseSimpleViewInit - ERREUR : ",e);
    return;
}
...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW REFUSAL AWAITING RESPONSE SIMPLE VIEW INIT - END");