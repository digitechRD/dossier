...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW CREATE NSS CICA SIMPLE VIEW INIT - START");
...
try {
    ...
    scriptLogger.error("[CUSTOM ACTION] - WorkflowCreateNSSCICASimpleViewInit - ERREUR : ",e);
    return;
}
...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW CREATE NSS CICA SIMPLE VIEW INIT - END");