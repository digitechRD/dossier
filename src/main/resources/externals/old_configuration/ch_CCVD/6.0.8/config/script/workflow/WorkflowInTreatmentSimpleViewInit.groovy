...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW IN TREATMENT SIMPLE VIEW INIT - START");
...
try {
    ...
    scriptLogger.error("[CUSTOM ACTION] - WorkflowInTreatmentSimpleViewInit - ERREUR : ",e);
    return;
}
...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW IN TREATMENT SIMPLE VIEW INIT - END");