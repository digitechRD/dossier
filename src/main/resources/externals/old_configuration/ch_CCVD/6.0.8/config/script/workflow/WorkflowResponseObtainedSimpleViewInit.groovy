...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW RESPONSE OBTAINED SIMPLE VIEW INIT - START");
...
try {
    ...
    scriptLogger.error("[CUSTOM ACTION] - WorkflowResponseObtainedSimpleViewInit - ERREUR : ",e);
    return;
}
...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW RESPONSE OBTAINED SIMPLE VIEW INIT - END");