...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW REFUSED URGENT SIMPLE VIEW INIT - START");
...
try {
    ...
    scriptLogger.error("[CUSTOM ACTION] - WorkflowRefusedUrgentSimpleView - ERREUR : ",e);
    return;
}
...
scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW REFUSED URGENT SIMPLE VIEW INIT - END");