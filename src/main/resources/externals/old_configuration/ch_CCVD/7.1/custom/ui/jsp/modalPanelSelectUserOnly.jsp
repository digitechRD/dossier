<jsp:root version="2.0" xmlns:f="http://java.sun.com/jsf/core"
  ...
  <h:panelGroup layout="block">
    <rich:panel rendered="#{CustomActionModel.modalPanelModel.DATA_ERROR_MSG==null and CustomActionModel.modalPanelModel.DATA_WARN_MSG==null}"
                style="height: 315px;">
      <h:outputLabel value="Taxateur" for="libelle"/>
      <h:selectOneMenu value="#{CustomActionModel.modalPanelModel.user}" rendered="#{not empty CustomActionModel.modalPanelModel.users}">
