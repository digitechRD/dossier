<jsp:root version="2.0" xmlns:f="http://java.sun.com/jsf/core"
  ...
  <dossier:actionBar id="sbcActionBar" backRendered="false">
    <ui:define name="secondaryActionPanel">
      <a4j:htmlCommandLink actionListener="#{GenericDownLoadController.processAction}" renderer="#{empty CustomActionModel.modalPanelModel.docsigned}"
