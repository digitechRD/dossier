  ...
  <h:panelGroup layout="block">
    <rich:panel rendered="#{CustomActionModel.modalPanelModel.DATA_ERROR_MSG==null and CustomActionModel.modalPanelModel.DATA_WARN_MSG==null}"
      ...
      <h:panelGrid id="panel" columns="2">
        ...
        <h:inputTextarea maxlenght="255" cols="40" rows="5" value="#{CustomActionModel.modalPanelModel.description}" onclick="this.focus()"
                         rendered="#{CustomActionModel.modalPanelModel.description!=null}"/>
      </h:panelGrid>
    </rich:panel>
