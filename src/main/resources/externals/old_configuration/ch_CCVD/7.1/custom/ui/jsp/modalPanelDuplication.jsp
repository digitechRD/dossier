<jsp:root version="2.0" xmlns:f="http://java.sun.com/jsf/core"
  ...
  <h:panelGrid id="panel" columns="2">
    <rich:panel rendered="#{CustomActionModel.modalPanelModel.DATA_ERROR_MSG==null and CustomActionModel.modalPanelModel.DATA_WARN_MSG==null}"
                style="height: 310px; width: 570px;">
      ...
      <h:selectOneMenu id="serviceList" value="#{CustomActionModel.modalPanelModel.SERVICE_LIST_VALUE}"
                       rendered="#{not empty CustomActionModel.modalPanelModel.SERVICE_LIST}">
        <f:selectItems id="itemsservice" value="#{CustomActionModel.modalPanelModel.SERVICE_LIST}"/>
      </h:selectOneMenu>

      <h:outputLabel value="Type :" for="libelle"/>
      <h:selectOneMenu id="typeList" value="#{CustomActionModel.modalPanelModel.TYPE_LIST_VALUE}"
                       rendered="#{not empty CustomActionModel.modalPanelModel.TYPE_LIST}">
