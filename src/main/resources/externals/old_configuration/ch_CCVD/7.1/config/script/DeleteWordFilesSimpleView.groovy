...
_scriptLogger.debug("[CUSTOM ACTION] - DELETE WORD FILES SIMPLE VIEW - START")
...
try {
  ...
  _scriptLogger.error("[CUSTOM ACTION] - DeleteWordFilesSimpleView - ERREUR : ", e)
  return
}
...
_scriptLogger.debug("[CUSTOM ACTION] - DELETE WORD FILES SIMPLE VIEW - END")