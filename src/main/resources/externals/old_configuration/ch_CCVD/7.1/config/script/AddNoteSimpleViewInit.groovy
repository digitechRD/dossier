...
_scriptLogger.debug("[CUSTOM ACTION] - ADD NOTE SIMPLE VIEW INIT - START")
...
try {
  ...
  _scriptLogger.error("[CUSTOM ACTION] - AddNoteSimpleViewInit - ERREUR : ", e)
  return
}
...
_scriptLogger.debug("[CUSTOM ACTION] - ADD NOTE SIMPLE VIEW INIT - END")