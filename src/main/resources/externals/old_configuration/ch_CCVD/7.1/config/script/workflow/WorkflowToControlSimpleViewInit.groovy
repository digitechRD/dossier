...
_scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW TO CONTROL SIMPLE VIEW INIT - START")
...
try {
  ...
  _scriptLogger.error("[CUSTOM ACTION] - WorkflowToControlSimpleView - ERREUR : ", e)
  return
}
...
_scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW TO CONTROL SIMPLE VIEW INIT - END")