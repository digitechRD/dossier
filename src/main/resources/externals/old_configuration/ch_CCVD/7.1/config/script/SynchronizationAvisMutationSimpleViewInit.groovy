...
_scriptLogger.debug("[CUSTOM ACTION] - SYNCHRONIZATION AVIS MUTATION SIMPLE VIEW INIT - START")
...
try {
  ...
  _scriptLogger.error("[CUSTOM ACTION] - SynchronizationAvisMutationSimpleViewInit - ERREUR : ", e)
  return
}
...
_scriptLogger.debug("[CUSTOM ACTION] - SYNCHRONIZATION AVIS MUTATION SIMPLE VIEW INIT - END")
