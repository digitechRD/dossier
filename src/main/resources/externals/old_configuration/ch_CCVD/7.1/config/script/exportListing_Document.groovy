...
import com.digitech.report.service.impl.ooo.*
...
try {
  ...
  generateListing(UserContext.getInstance(), exportODTFilePath, exportDestPathODT, exportDestPath, ExportPath, documents, DossierCoreContext.getParamsInfos().getOfficeConfiguration(), result)
...
/******************************* listing generation  ******************************/
void generateListing(UserCoreContext usrContext, String odt_templateFilePath, String odt_resultFilePath, String resultFilePath, String tempFilePath,
                            List<IDocument> docList, DefaultOfficeManagerConfiguration configuration, ScriptResultValueExportInitializer result)
