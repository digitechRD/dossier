 ...
 **************************************************************************************************/
_scriptLogger.debug("[CUSTOM ACTION] - EDIT FIRST ATTACHMENT - START")
...
try {
  ...
  _scriptLogger.error("[CUSTOM ACTION] - EditFirstAttachment - ERREUR : ", e)
  return
}
...
try {
  ...
  String historic = "Modification de la pièce jointe par " + userContext.getUserId()
...
_scriptLogger.debug("[CUSTOM ACTION] - EDIT FIRST ATTACHMENT - END")
