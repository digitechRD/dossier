...
_scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW AWAITING RESPONSE SIMPLE VIEW INIT - START")
...
try {
  ...
  _scriptLogger.error("[CUSTOM ACTION] - WorkflowAwaitingResponseSimpleViewInit - ERREUR : ", e)
  return
}
...
_scriptLogger.debug("[CUSTOM ACTION] - WORKFLOW AWAITING RESPONSE SIMPLE VIEW INIT - END")