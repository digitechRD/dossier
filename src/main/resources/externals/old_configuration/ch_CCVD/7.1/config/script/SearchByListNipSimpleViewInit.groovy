...
_scriptLogger.debug("[CUSTOM ACTION] - SEARCH BY LIST NIP SIMPLE VIEW INIT - START")
...
try {
  ...
  _scriptLogger.error("[CUSTOM ACTION] - SearchByListNipSimpleViewInit - ERREUR : ", e)
  return
}
...
_scriptLogger.debug("[CUSTOM ACTION] - SEARCH BY LIST NIP SIMPLE VIEW INIT - END")
