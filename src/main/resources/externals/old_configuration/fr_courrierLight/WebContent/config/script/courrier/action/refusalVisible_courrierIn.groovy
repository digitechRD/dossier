...
log.debug("Script triggered on refusal visibility : refusalVisible_courrierIn.groovy --- Start");
...
log.debug("Script triggered on refusal visibility : refusalVisible_courrierIn.groovy --- End");