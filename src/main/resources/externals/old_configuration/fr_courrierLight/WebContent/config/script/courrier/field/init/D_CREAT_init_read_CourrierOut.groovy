...
logger.debug("Script field initialization: D_CREAT_init_read_CourrierOut.groovy --- Start");
...
logger.debug("Script field initialization: D_CREAT_init_read_CourrierOut.groovy --- End");
