...
String PROFILE_CODE = "PF_ACHAT";
Integer PROFILE_ID = 110;
String SCRIPT_NAME="user_ElementFilter_Achat.groovy";
...
scriptLogger.debug("Script ElementFilter : "+SCRIPT_NAME+" --- Add :"+getUserMgr().getUser(usrAdm.getId()));
