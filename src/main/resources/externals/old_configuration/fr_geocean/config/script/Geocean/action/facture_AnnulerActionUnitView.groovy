...
// Objet : Script appelé lors de l'action "Annuler" sur un type de document
//         Facture
// Descritpions :
//  - 
// ****************************************************************************
...
log.debug("In facture_AnnulerActionUnitView.groovy v1.0 (id [" + theDocument.getAirsRefId() + "])");
...
if (comment != null && !comment.equals(""))
{
	...
	if (afficheLesLog)
		log.debug("facture_AnnulerActionUnitView.groovy : Ajout commentaire [" + comment + "]");
...
else
{
	...
	if (afficheLesLog)
		log.debug("facture_AnnulerActionUnitView.groovy : Aucun commentaire");
}

if (valeurRetour)
{
	ActionWorkflow(theDocument, usrContext, "CODE_ANNULEE", "CODE_NON", "event_annuler");
}
...
if (valeurRetour)
{
	...
	log.debug("Out facture_AnnulerActionUnitView.groovy : Ok");
}
else
{
	...
	log.debug("Out facture_AnnulerActionUnitView.groovy : Ko [" + messageSummary + "]");
}
