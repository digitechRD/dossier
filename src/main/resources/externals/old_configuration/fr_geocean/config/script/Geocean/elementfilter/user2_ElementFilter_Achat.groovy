...
String SCRIPT_NAME = "user2_ElementFilter_Achat.groovy";
...
IField UGUserField = fieldMap.get("FACT_USR_ACHAT");

Integer PROFILE_ID = 110;
...
scriptLogger.debug("Script ElementFilter : "+SCRIPT_NAME+" --- Add :"+usrToAdd.getId());
