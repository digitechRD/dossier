...
log.debug("In facture_initCommentAndUserUnitView_panel.groovy v1.0 (id [" + theDocument.getAirsRefId() + "])");
...
customActionModel.setModalPanelTitle(BundleUtils.getTranslation("modalPanelCommentUser_title"));
...
log.debug("Out facture_initCommentAndUserUnitView_panel.groovy");
