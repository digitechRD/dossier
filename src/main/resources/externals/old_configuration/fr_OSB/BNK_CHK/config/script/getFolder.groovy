...
private  String LINK_CODE = "RECTO-VERSO"


//code des champs que l'on va traiter
private  String SENSIMG_FIELD_CODE = "SEN_IMG";
private  String TYP_DOC_FIELD_CODE = "TYP_DOC";

// valeur des champs a traiter
private  String SENSIMG_FIELD_VALUE_RECTO   = "303";
private  String SENSIMG_FIELD_VALUE_VERSO   = "304";
private  String TYP_DOC_FIELD_VALUE_CHEQUE  = "203";
private  String TYP_DOC_FIELD_VALUE_REMISE  = "204";
			...
			if(childIds != null) {
				...
				for(Integer childId : childIds) {
					    ...
					    && sensImgValue.equalsIgnoreCase(SENSIMG_FIELD_VALUE_RECTO ))
					{
						...
						for( IDocument docLinked : getLinkedDocument( UserContext.getInstance(), docToAdd, LINK_CODE ))
						{
							scriptLogger.debug(" [OCSD] - getFolder - Addinfg docId : " + docLinked.getAirsRefId() + " ( Remise _ verso ) to final list.")
