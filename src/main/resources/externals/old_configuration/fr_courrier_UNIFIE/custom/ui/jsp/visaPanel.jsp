  ...
  <h:panelGroup styleClass="visaPanel">
    <h:panelGrid columns="2" styleClass="visaPanel">
      ...
      <h:panelGroup id="buttonPanelGroup">
        <h:outputLabel
            value="#{MessageBundleModel.label_select_item_response}"/>
        ...
        <c:if test="#{ApplicationModel.javaWebStartActivated}">
          <a4j:commandLink immediate="true"
                           ...
                           oncomplete="Richfaces.showModalPanel('editDocumentLauncherModalPanelResponse');"
                           reRender="editDocumentLauncherModalPanelResponse">
