...
log.debug("Script triggered on removing from copy : removeFromCopy_ViewUnitRead.groovy --- Start");
...
usrContext.setCurrentDocument(CourrierScriptUtils.getDocumentMgr().getDocument(usrContext, theDocument.getAirsRefId()));
Utils.getSearchResultController().replay();
log.debug("Script triggered on removing from copy : removeFromCopy_ViewUnitRead.groovy --- End");