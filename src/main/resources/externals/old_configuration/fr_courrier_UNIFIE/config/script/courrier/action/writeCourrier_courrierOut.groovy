...
log.debug("Script triggered on response : writeCourrier_courrierOut.groovy --- Start");

// Ajouter la pièce jointe générée aux documents 
...
log.debug("Script triggered on response : writeCourrier_courrierOut.groovy --- End");
