...
logger.debug("Script field initialization: U_CREAT_init_read_CourrierIn.groovy --- Start");
...
logger.debug("Script field initialization: U_CREAT_init_read_CourrierIn.groovy --- End");
