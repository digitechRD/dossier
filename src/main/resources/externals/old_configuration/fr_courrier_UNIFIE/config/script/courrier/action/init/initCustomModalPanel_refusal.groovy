...
log.debug("Script triggered on init custom Modal Panel: initCustomModalPanel_refusal.groovy --- Start");
...
customActionModel.setModalPanelTitle(BundleUtils.getTranslation("modalPanelRefusal_title"));

log.debug("Script triggered on init custom Modal Panel: initCustomModalPanel_refusal.groovy --- End");