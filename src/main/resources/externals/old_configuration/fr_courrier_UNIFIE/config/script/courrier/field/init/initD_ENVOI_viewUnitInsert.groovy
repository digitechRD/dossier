...
logger.debug("Script field initialization: initD_ENVOI_viewUnitInsert.groovy --- Start");
...
logger.debug("Script field initialization: initD_ENVOI_viewUnitInsert.groovy --- End");