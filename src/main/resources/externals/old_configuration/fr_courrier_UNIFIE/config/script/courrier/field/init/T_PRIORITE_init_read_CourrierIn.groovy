...
logger.debug("Script field initialization: T_PRIORITE_init_read_CourrierIn.groovy --- Start");
...
logger.debug("Script field initialization: T_PRIORITE_init_read_CourrierIn.groovy --- End");
