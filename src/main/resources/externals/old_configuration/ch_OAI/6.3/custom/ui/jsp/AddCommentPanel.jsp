<jsp:root version="2.0" xmlns:f="http://java.sun.com/jsf/core"
	...
	<h:panelGroup layout="block">
		<rich:panel style="position:relative; border:none; padding-bottom: 15px; height:310px; width:574px;" rendered="#{CustomActionModel.modalPanelModel.DATA_ERROR_MSG==null}">
			<rich:panel header="#{MessageBundleModel.jsp_comment}" style="overflow:auto; width:550px; height: auto; max-height: 250px; margin-top: 2px; margin-buttom: 0px">
			...
			<rich:panel header="#{MessageBundleModel.jsp_comment_page}" style="overflow:auto; width:550px; height: auto; max-height: 50px; margin-top: 2px; margin-buttom: 0px">
				<rich:panel style="border-width: 0px; padding-top:0px; margin-top: 0px;">
