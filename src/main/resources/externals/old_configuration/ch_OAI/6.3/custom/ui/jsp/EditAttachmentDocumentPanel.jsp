<jsp:root version="2.0" xmlns:f="http://java.sun.com/jsf/core"
	...
	<h:panelGroup layout="block">
        <rich:panel style="position:relative; border:none; padding-bottom: 15px; height:310px; width:574px;" rendered="#{CustomActionModel.modalPanelModel.DATA_ERROR_MSG==null}">
            ...
            <rich:panel id="deletePages" header="#{MessageBundleModel.jsp_pages_deleted}" style="overflow:auto; width:550px; height: auto; max-height: 272px; display:block;">
                <rich:dataTable
            ...
            <rich:panel id="copyPages" header="#{MessageBundleModel.jsp_pages_copy}" style="overflow:auto; width:550px; height: auto; max-height: 200px; display:none;">
            ...
            <rich:panel id="insertPages" header="#{MessageBundleModel.jsp_pages_insert}" style="overflow:auto; width:550px; height: auto; max-height: 200px; display:none;">
            ...
            <rich:panel id="rotationPages" header="#{MessageBundleModel.jsp_pages_rotation}" style="overflow:auto; width:550px; height: auto; max-height: 250px; display:block;">
                <rich:dataTable
                            styleClass="customActionDataTable"
                            cellpadding="0" cellspacing="0"
