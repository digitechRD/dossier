...
try{
    ...
    String link = Constants.APPLICATION_AIRSDOSSIER_URL+"faces/redirect.jsp?authentication="+userEncode+"&orgId="+userContext.getCurrentOrgId()+
            "&outcome=gotoSimpleView&cty="+Constants.CTY_DOCUMENT_ASSURE+"&field1="+Constants.FIELD_NSS_CODE+"&value1="+document.getField(Constants.FIELD_NSS_CODE).getValue().toString();
