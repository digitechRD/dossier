...
public class Methods {
    ...
    public static String getAirsRequestForUser(String tmpRequest,UserCoreContext userContext){
     ...
     * @throws Exception
     */
    public static List<Document> getDocumentsListByNSS(String contentType, String nss, String field, List<String> values, String beginDate, String endDate, boolean isAdmin, UserCoreContext userCoreContext) throws Exception {
    ...
    public static List<Document> getDocumentsListByNSS(List<IDocument> documentList, String field, List<String> values, Date beginDate, Date endDate, boolean isAdmin) throws Exception {
        List<Document> result = new ArrayList<Document>();
    ...
    public static List<Integer> getDocumentsListIdByNSS(List<IDocument> documentList, String field, List<String> values, Date beginDate, Date endDate, boolean isAdmin) throws Exception {
    ...
    public static String  getGroupeByTypeDoc(String typeId) throws Exception{
        String groupId = null;
        if(typeId!=null) {
     ...
     * @throws Exception
     */
    public static List<Integer> getDocumentsListIdByNSS(String contentType, String nss, String field, List<String> values, String beginDate, String endDate, boolean isAdmin) throws Exception {
        List<Domain> listDomain = new ArrayList();
        listDomain.add(new Domain(DossierCoreContext.getAdminJeton(), contentType));
     ...
     * @throws Exception
     */
    public static List<Integer> getDocumentsListIdByNSS(String contentType, String nss, String field, List<String> values, String beginDate, String endDate, boolean isAdmin, UserCoreContext userContext) throws Exception {
        List<Domain> listDomain = new ArrayList();
     ...
     * @throws Exception
     */
    public static List<Integer> getDocumentsListIdByNSS(String contentType, String nss) throws Exception {
        List<Domain> listDomain = new ArrayList();
        listDomain.add(new Domain(DossierCoreContext.getAdminJeton(), contentType));
        Request req = new Request();
        req.addLocution(Constants.FIELD_NSS_CODE, Request.Operator.OPERATOR_EQUAL, nss);
     ...
     * @throws Exception
     */
    public static List<Integer> getDocumentsListIdByDay(String contentType, Date date, boolean isDeleted) throws Exception {
        List<Domain> listDomain = new ArrayList();
        listDomain.add(new Domain(DossierCoreContext.getAdminJeton(), contentType));
        Request req = new Request();
     ...
     * @throws Exception
     */
    public static List<Integer> getFoldersHasRemove(Date date) throws Exception {
        List<Domain> listDomain = new ArrayList();
     ...
     * @return
     */
    public static String downloadAttachment(String tempFilePath, IDocument document, IAttachment attachment)
    ...
    public static void writeHeader(PdfPTable table, String noDoc, String ndem, String date, String typeDoc, String author, String nbPage,boolean borderBottom) throws Exception {
    ...
    public static void writeHeader(PdfPTable table, String noDoc, String ndem, String date, String typeDoc, String author, String nbPage,String dateEmission, boolean borderBottom) throws Exception {
     ...
     */
    public static void setPagingPage(String file, String exportPath, List<Integer> numeroPage,List<String> labelNumDossier,List<String> labelTypeDoc,List<String> labelDateDoc, Properties conf) throws Exception  {
        try {
    ...
    public static void setPagingPage(String file, String exportPath, List<Integer> numeroPage) throws Exception {
        try {
    ...
    public static boolean isActorInProfil(int userId, String profilCode) throws Exception {
     ...
     * @throws Exception
     */
    public static boolean isActorInProfil(int userId, List<String> profilsId) throws Exception {
    ...
    public static IDocumentConvertionService getDocumentConversionService() {
     ...
     * @throws Exception
     */
    public static List<Object> getFieldMultiValue(IDocument document, String fieldCode) throws Exception {
     ...
     * @throws Exception
     */
    public static String getFieldValue(Document document, String fieldCode) throws Exception {
        try{
     ...
     */
    public static String addValueInFieldMultiValue(IDocument document, String fieldCode, Map<Integer, Boolean> items, String userId) throws Exception {
        String result = "";
     ...
     * @throws Exception
     */
    public static String addValueInFieldMultiValue(IDocument document, String fieldCode, Integer item) throws Exception {
        String result = "";
        List<Object> list = getFieldMultiValue(document, fieldCode);
        if (list != null){
     ...
     * @throws Exception
     */
    public static Map<Integer, String> getUsersByOrganizationMap(int organizationId) throws Exception {
     ...
     * @throws Exception
     */
    public static List<SelectItem> getUsersByOrganizationListOfSelectItem(int organizationId) throws Exception {
    ...
    public static List<SelectItem> getUsersByProfilListOfSelectItem(int organizationId) throws Exception {
        List<SelectItem> result = new ArrayList<SelectItem>();
     ...
     * @throws Exception
     */
    public static List<SelectItem> getAuthorityListOfSelectItem(int authorityListId) throws Exception {
        List<SelectItem> result = new ArrayList<SelectItem>();
    ...
    public static Map<String, List<SelectItem>> getDependencyTypesGroups(){
     ...
     * @throws Exception
     */
    public static List<SelectItem> getContentsListOfSelectItem(org.w3c.dom.Document xmlDocument, String request) throws Exception {
     ...
     * @throws Exception
     */
    public static List<String> getContentsList(org.w3c.dom.Document xmlDocument, String request) throws Exception {
     ...
     * @throws Exception
     */
    public static List<String> getContentsListWithFormat(org.w3c.dom.Document xmlDocument, String request, String format) throws Exception {
        List<String> result = new ArrayList();
        XPath xPath = XPathFactory.newInstance().newXPath();
        NodeList nodeList = (NodeList) xPath.compile(request).evaluate(xmlDocument, XPathConstants.NODESET);
        Node node = (Node) nodeList.item(0);
     ...
     * @throws Exception
     */
    public static boolean isContentExist(org.w3c.dom.Document xmlDocument, String request) throws Exception {
        XPath xPath = XPathFactory.newInstance().newXPath();
        NodeList nodeList = (NodeList) xPath.compile(request).evaluate(xmlDocument, XPathConstants.NODESET);
     ...
     * @throws Exception
     */
    public static String getContent(org.w3c.dom.Document xmlDocument, String request) throws Exception {
        XPath xPath = XPathFactory.newInstance().newXPath();
     ...
     * @throws Exception
     */
    public static List<SelectItem> listToSelectItem(List<String> list) throws Exception {
        List<SelectItem> result = new ArrayList();
     ...
     * @throws Exception
     */
    public static String completeNssForSearch(String nss) throws Exception {
     ...
     * @throws Exception
     */
    public static boolean isNSSValid(String nss) throws Exception {
     ...
     * @throws Exception
     */
    public static String convertDateForAIRS(String date) throws Exception {
     ...
     * @throws Exception
     */
    public static List<String> getListNSSDocumentbyRequest(String request) throws Exception {
     ...
     * @throws Exception
     */
    public static List<Integer> getListIdDocumentbyRequest(String request) throws Exception {
        List<Integer> result = new ArrayList<Integer>();
        java.sql.Connection conn = null;
        Statement ps = null;
        ResultSet rs = null;
    ...
    public static Integer executeRequest(String request) throws Exception {
        Integer result = 0;
        java.sql.Connection conn = null;
        Statement ps = null;
    ...
    public static void concatPdf(PdfCopy copy, String file) throws Exception {
    ...
    public static void concatPdf(PdfCopy copy, String file, ArrayList<HashMap<String, Object>> outlines) throws Exception {
        try {
            PdfReader reader;
            int n = 0;
            reader = new PdfReader(file);
    ...
    public static ProfilAdmin hasActorGeneric(List<Object> users, Integer userId){
    ...
    public static ProfilAdmin hasActorGeneric(List<Object> users){
        List<ProfilAdmin> profiles = ProfilsManager.loadAll(DossierCoreContext.getAdminJeton());
        for(Object id : users){
            UserAdmin user = UsersManager.load(DossierCoreContext.getAdminJeton(), Integer.parseInt(String.valueOf(id)));
            String profilName = "CORBEILLE_"+user.getLogin();
    ...
    public static String getActors(String nss) throws Exception{
        String result = null;
        ...
        try {
            ...
            try {
                ...
                while (resultat.next()) {
                    ...
                    if (result != null && gestId != null) {
                        if(!Arrays.asList(result.split(";")).contains(gestId)) result = result + ";" + gestId;
                    } else if (gestId != null) {
                        result = gestId;
                    }
                }
            ...
            if (result == null && (conf.getProperty("webai.db.req4") == null || !"".equals(conf.getProperty("webai.db.req4")))) {
            ...
            if (result == null && (conf.getProperty("webai.db.req5") == null || !"".equals(conf.getProperty("webai.db.req5")))) {
            ...
            if (result == null && (conf.getProperty("webai.db.req6") == null || !"".equals(conf.getProperty("webai.db.req6")))) {
    ...
    public static Integer getUserIdBasketByProfil(ProfilAdmin profilAdmin){
    ...
    public static Integer getUserIdBasketByProfil(ProfilAdmin profilAdmin, List<Integer> listUsers){
        String userLogin = profilAdmin.getCode().replaceAll("CORBEILLE_", "");
        String userLogin2 = profilAdmin.getCode().replaceAll("OAITI_WF_", "");
        String serviceLogin = profilAdmin.getCode().replaceAll("SERVICE_", "").split("::")[0];
        for(UserAdmin userAdmin : profilAdmin.getUsers()){
    ...
    public static String getUserId(String login) throws Exception {
        String result = null;
    ...
    public static String isConfidentiel(String nss) throws Exception{
        String result = null;
        Properties conf = new Properties();
        InputStreamReader inputStreamReader = null;
        java.sql.Connection connection = null;
    ...
    public static List<SelectItem> getStakeholdersInWebAI(String nss) throws Exception{
        List<SelectItem> result = new ArrayList();
        Properties conf = new Properties();
        InputStreamReader inputStreamReader = null;
        java.sql.Connection connection = null;
    ...
    public static List<SelectItem> getStakeholdersInWSWebAI(String nss) throws Exception{
        List<SelectItem> result = new ArrayList();
        Properties conf = new Properties();
        InputStreamReader inputStreamReader = null;
		 String res="";
        try {
            ...
            res= getInformationFromWebAI(conf.getProperty("webai.url.intervenants"), conf.getProperty("webai.json.request.intervenants").replace("##NSS##", nss), conf.getProperty("webai.json.request.intervenant.information"));
            if (!res.isEmpty()) {
                JSONArray jsonObjRes = new JSONArray(res);
                for(int cpt=0;cpt<jsonObjRes.length();cpt++){
                    result.add(new SelectItem(jsonObjRes.getJSONObject(cpt).getString(conf.getProperty("webai.json.request.intervenant.information.email")), jsonObjRes.getJSONObject(cpt).getString(conf.getProperty("webai.json.request.intervenant.information.nom"))+"("+jsonObjRes.getJSONObject(cpt).getString(conf.getProperty("webai.json.request.intervenant.information.email"))+")"));
                }
            }
        } catch (Exception e) {
    ...
    public static List<String> getRequestInWebAI(String nss, String typeQuery) throws Exception{
        List<String> result = new ArrayList();
        Properties conf = new Properties();
        InputStreamReader inputStreamReader = null;
        java.sql.Connection connection = null;
	...
	public static String getNameInWSWebAI(String nss) throws Exception{
        String result = "";
        Properties conf = new Properties();
        InputStreamReader inputStreamReader = null;
	...
	public static void convertTiffToPDF(File tifFile, File pdfFile) {
    ...
    public static String getPassWordOfUser(String login){
        String result = null;
        java.sql.Connection conn = null;
        Statement ps = null;
        ResultSet rs = null;
    ...
    public static void logActionUser(String action, String filter, String numberOfDocument, String userLogin, String criteria){
        int res=0;
        java.sql.Connection conn = null;
        Statement ps = null;
		String query = null;
    ...
    public static String getInformationFromWebAI(String URL, String request, String informationRequest) {
...
class CustomComparatorTerm implements Comparator<AuthorityListTermAdmin> {
    ...
    @Override
    public int compare(AuthorityListTermAdmin o1, AuthorityListTermAdmin o2) {
