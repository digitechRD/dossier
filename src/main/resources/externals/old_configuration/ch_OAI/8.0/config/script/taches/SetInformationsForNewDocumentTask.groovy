...
try {
        ...
        if(typeId != null || name == null || name.isEmpty() || numberPage != null) {
          ...
          if(numberPage == null) {
            ...
            if(!doc.getPrimaryDocList().isEmpty()) {
              try {
                ...
                if(StringUtils.isExtensionIgnoreCase(file.getName(), Constants.APPLICATION_PDF_EXTENSION)) {
                  ...
                  try {
                    ...
                    numberPage = tiffImage.getImageCount()
                  }
                  finally {
                    if(tiffImage != null) {
                      tiffImage.close()
              ...
              scriptLogger.debug("[CUSTOM ACTION] - SetInformationsForNewDocumentTask - Document sans pièce jointe : " + id)
          }
  ...
  scriptLogger.debug("[CUSTOM ACTION] - SetInformationsForNewDocumentTask - Nombre de documents deverouillé : " +
                         Methods.executeRequest(Constants.DB_AIRS_REQUEST_UNLOCK_DOCUMENTS))
