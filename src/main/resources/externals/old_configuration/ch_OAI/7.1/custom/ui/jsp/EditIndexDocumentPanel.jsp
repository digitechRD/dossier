<jsp:root version="2.0" xmlns:f="http://java.sun.com/jsf/core"
  ...
  <h:panelGroup layout="block">
    <rich:panel style="position:relative; border:none; height:310px; width:574px;" rendered="#{CustomActionModel.modalPanelModel.DATA_ERROR_MSG==null}">
      <rich:panel header="#{MessageBundleModel.jsp_edit}"
                  style="overflow:auto; width:550px; height: auto; max-height: 250px; margin-top: 0px; margin-buttom: 0px">
        ...
        <div id="panel_N_DEM" style="border-width: 0px;padding-top:0px; margin-top: 10px; display:none;">
          ...
          <h:selectOneMenu id="ndem" required="true" editable="true" value="#{CustomActionModel.modalPanelModel.DATA_FIELD_N_DEM}"
        ...
        <div id="panel_AL_ASSURE_GROUPE_DOC" style="border-width: 0px; padding-top:0px; margin-top: 10px;">
          ...
          <h:selectOneMenu id="groupsDocument" required="true" onchange="displayTypesList(this.value, false);"
                           value="#{CustomActionModel.modalPanelModel.DATA_FIELD_AL_ASSURE_GROUPE_DOC}"
                           rendered="#{not empty CustomActionModel.modalPanelModel.DATA_LIST_DOCUMENT_GROUPS}">
