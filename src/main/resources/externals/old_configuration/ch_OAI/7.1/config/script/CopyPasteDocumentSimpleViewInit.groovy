...
try {
  ...
  data.
      put("DATA_DEM", (document.getField(Constants.FIELD_DEM_CODE).getValue() == null) ? "" : document.getField(Constants.FIELD_DEM_CODE).getValue().toString())
  data.put("DATA_DATE", (document.getField(Constants.FIELD_DATE_DOCUMENT_CODE).getValue() == null) ? "" :
      document.getField(Constants.FIELD_DATE_DOCUMENT_CODE).getValue().toString())
