...
try {
  ...
  if(document.getAirsDocument().getInnerDocument().getNotes().isEmpty())
    Methods.addStateMessage(data, "DATA_ERROR_MSG", BundleUtils.getTranslation("groovy_comment_empty"), false)
  else {
