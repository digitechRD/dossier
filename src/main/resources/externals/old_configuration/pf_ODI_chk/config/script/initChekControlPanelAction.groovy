...
customActionModel.setModalPanelHeight( 680 );
customActionModel.setModalPanelWidth( 785 );
...
List<IDocument> selectedDocumentsList =  Utils.getSearchResultTableController().getModel().getSelectedDocuments();
