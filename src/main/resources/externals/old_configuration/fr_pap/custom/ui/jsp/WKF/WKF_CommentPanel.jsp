<jsp:root version="2.0" xmlns:f="http://java.sun.com/jsf/core"
	...
	<h:panelGroup id="CommentPanel" rendered="#{CustomActionController.model.modalPanelModel.displayPanelComment}">
		<h:panelGroup layout="block">
			<h:outputLabel value="Commentaire : " />
			<h:inputTextarea value="#{CustomActionController.model.modalPanelModel.comment}"
