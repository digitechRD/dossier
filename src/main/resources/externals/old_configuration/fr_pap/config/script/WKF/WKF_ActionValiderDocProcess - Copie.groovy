...
final boolean COMMENTAIRE_OBLIGATOIRE = false; // ⬅️ Passe à true si besoin
...
if (StringUtils.isNotBlank(comment)) {
	...
	ScriptUtilsProject.getAuditMgr().addDocumentEvent(userContext, document, AdvancedAuditType.ADV_EVENT_WF_TASK_SUBMIT.name(), BundleUtils.getTranslation("WKF_ActionValiderDocProcess"));
	switch(ScriptUtilsProject.getTermCode("MSC_ETAPE_EN_COURS", FieldUtils.getValue(document,"MSC_ETAPE_EN_COURS"))) {
		...
		case "controle_demande":
			...
			FieldUtils.setValue(document, "MSC_ETAT_MONTEE", Integer.toString(ScriptUtilsProject.getTermID("MSC_ETAT_MONTEE", "payee")));
			break
		// case "elaboration_envoi_devis":
			// FieldUtils.setValue(document, "MSC_ETAPE_EN_COURS", Integer.toString(ScriptUtilsProject.getTermID("MSC_ETAPE_EN_COURS", "paiement_preuve")));
			// FieldUtils.setValue(document, "MSC_ETAT_MONTEE", Integer.toString(ScriptUtilsProject.getTermID("MSC_ETAT_MONTEE", "planifiee")));
			// break
		// case "paiement_preuve":
			// FieldUtils.setValue(document, "MSC_ETAPE_EN_COURS", Integer.toString(ScriptUtilsProject.getTermID("MSC_ETAPE_EN_COURS", "constitution_dossier")));
			// FieldUtils.setValue(document, "MSC_ETAT_MONTEE", Integer.toString(ScriptUtilsProject.getTermID("MSC_ETAT_MONTEE", "payee")));
			// break
		...
		case "verification_dossier":
			FieldUtils.setValue(document, "MSC_ETAPE_EN_COURS", Integer.toString(ScriptUtilsProject.getTermID("MSC_ETAPE_EN_COURS", "visa_dir_adj_infra_exploit")));
			FieldUtils.setValue(document, "MSC_ETAT_MONTEE", Integer.toString(ScriptUtilsProject.getTermID("MSC_ETAT_MONTEE", "en_instruction_verifie")));
			break
		case "visa_dir_adj_infra_exploit":
			FieldUtils.setValue(document, "MSC_ETAPE_EN_COURS", Integer.toString(ScriptUtilsProject.getTermID("MSC_ETAPE_EN_COURS", "visa_charge_environnement")));
			break
		case "visa_charge_environnement":
			FieldUtils.setValue(document, "MSC_ETAPE_EN_COURS", Integer.toString(ScriptUtilsProject.getTermID("MSC_ETAPE_EN_COURS", "visa_commandant_port")));
			break
		case "visa_commandant_port":
			FieldUtils.setValue(document, "MSC_ETAPE_EN_COURS", Integer.toString(ScriptUtilsProject.getTermID("MSC_ETAPE_EN_COURS", "visa_agent_comptable")));
			break
		case "visa_agent_comptable":
			...
			break
		case "signature":
			FieldUtils.setValue(document, "MSC_ETAPE_EN_COURS", Integer.toString(ScriptUtilsProject.getTermID("MSC_ETAPE_EN_COURS", "transmission_dossier_signe_client")));
			FieldUtils.setValue(document, "MSC_ETAT_MONTEE", Integer.toString(ScriptUtilsProject.getTermID("MSC_ETAT_MONTEE", "en_instruction_signe")));
			break
		case "transmission_dossier_signe_client":
		...
		case "montee_sur_cale":
			FieldUtils.setValue(document, "MSC_ETAPE_EN_COURS", Integer.toString(ScriptUtilsProject.getTermID("MSC_ETAPE_EN_COURS", "cloture_montee_sur_cale")));
			FieldUtils.setValue(document, "MSC_ETAT_MONTEE", Integer.toString(ScriptUtilsProject.getTermID("MSC_ETAT_MONTEE", "montee_sur_cale_a_cloturer")));
			break
		case "cloture_montee_sur_cale":
			FieldUtils.setValue(document, "MSC_ETAPE_EN_COURS", Integer.toString(ScriptUtilsProject.getTermID("MSC_ETAPE_EN_COURS", "facturation_montee_sur_cale")));
			FieldUtils.setValue(document, "MSC_ETAT_MONTEE", Integer.toString(ScriptUtilsProject.getTermID("MSC_ETAT_MONTEE", "montee_sur_cale_a_facturer")));
			break
		case "facturation_montee_sur_cale":
			FieldUtils.setValue(document, "MSC_ETAPE_EN_COURS", Integer.toString(ScriptUtilsProject.getTermID("MSC_ETAPE_EN_COURS", "montee_sur_cale_terminee")));
			FieldUtils.setValue(document, "MSC_ETAT_MONTEE", Integer.toString(ScriptUtilsProject.getTermID("MSC_ETAT_MONTEE", "montee_sur_cale_terminee")));
			break	
	}
	...
	if (COMMENTAIRE_OBLIGATOIRE) {
		...
		scriptLogger.debug("WKF_ActionValiderDocProcess.groovy : Aucun commentaire - blocage activé");
	} else {
		scriptLogger.debug("WKF_ActionValiderDocProcess.groovy : Aucun commentaire - autorisé (commentaire facultatif)");
	}
}
