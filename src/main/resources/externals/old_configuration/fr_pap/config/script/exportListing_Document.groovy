...
try {
  ...
  generateListing(UserContext.getInstance(), exportODTFilePath, exportDestPathODT, exportDestPath, ExportPath, documents, DossierCoreContext.getOfficeConfiguration(), result)
