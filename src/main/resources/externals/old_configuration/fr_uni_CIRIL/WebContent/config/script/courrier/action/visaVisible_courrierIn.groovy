...
log.debug("Script triggered on visa Visibility : visaVisible_courrierIn.groovy --- Start");
...
log.debug("Script triggered on visa Visibility : visaVisible_courrierIn.groovy --- End");