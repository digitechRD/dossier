...
logger.debug("Script field initialization: T_TYPE_init_read_CourrierOut.groovy --- Start");
...
logger.debug("Script field initialization: T_TYPE_init_read_CourrierOut.groovy --- End");
