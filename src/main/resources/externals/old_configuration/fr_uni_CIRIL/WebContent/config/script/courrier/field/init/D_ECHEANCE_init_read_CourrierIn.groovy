...
logger.debug("Script field initialization: D_ECHEANCE_init_read_CourrierIn.groovy --- Start");
...
logger.debug("Script field initialization: D_ECHEANCE_init_read_CourrierIn.groovy --- End");
